...
![The Conrad Challenge finalists stand together across the full event stage after the awards.](./eldercare-robot/conrad-finalists-stage.jpg)
...
![A team member crouches beside the robot while checking a lower connection.](./eldercare-robot/testing-adjustment.webp)

*A close check after the prototype stopped during testing.*

![The robot is tested at walking distance in an open indoor space.](./eldercare-robot/testing-distance.webp)

*The wider test made the distance between a person and the moving prototype visible.*

![A team member works from behind the prototype during a second debugging stop.](./eldercare-robot/testing-debugging.webp)
...
![The full ElderGo prototype beside a team member using a connected laptop.](./eldercare-robot/prototype-overview.webp)

*The complete prototype and the separate computer used while checking it.*

![The open rear of the prototype reveals the wheel assembly and internal cables.](./eldercare-robot/prototype-interior.webp)

*Rear access exposed the cables and wheel assembly during debugging.*

![A close view of the prototype's front-facing camera and sensor assembly.](./eldercare-robot/sensor-array.webp)
...
![The completed prototype stands between team members during the final presentation.](./eldercare-robot/result-presentation.webp)
